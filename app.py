...
with tab2:
    # Double Highlighted Internal Header using HTML
    st.markdown("<div style='background-color: #5e9900; padding: 10px; border-radius: 5px;'><h2 style='color: white; margin: 0; padding-left: 10px;'>🔵 SECTION 2: AXIS, SHAPE & LENGTH</h2></div>", unsafe_allow_html=True)
    st.write("") # Blank space
...
with tab3:
    # Double Highlighted Internal Header using HTML
    st.markdown("<div style='background-color: #778c01; padding: 10px; border-radius: 5px;'><h2 style='color: white; margin: 0; padding-left: 10px;'>🟠 SECTION 3: MICROSCOPIC SHAPE FACTORS</h2></div>", unsafe_allow_html=True)
    st.write("") # Blank space
